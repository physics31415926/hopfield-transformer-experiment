...
## Experiment 8: Public Benchmarks — WikiText-103, LAMBADA & HellaSwag

> Evaluate all three variants on standard public NLP benchmarks.
> WikiText-103 tests general language modeling perplexity; LAMBADA tests long-range dependency via last-word prediction accuracy; HellaSwag tests commonsense reasoning via 4-choice sentence completion.
...
- **HellaSwag**: 10,042 examples, 4-choice commonsense sentence completion, length-normalized log-likelihood scoring
